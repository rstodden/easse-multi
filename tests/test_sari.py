...
def test_corpus_sari_legacy():
    orig_sents = get_orig_sents('turkcorpus_test_legacy', input_level="sentence-level")
    refs_sents = get_refs_sents('turkcorpus_test_legacy', input_level="sentence-level")
